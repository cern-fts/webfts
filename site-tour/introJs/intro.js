  ...
  function _showElement(targetElement) {
    ...
    if (this._currentStep == 0 && this._introItems.length > 1) {
      ...
      skipTooltipButton.innerHTML = this._options.skipLabel;
        ...
        if(document.title == 'WebFTS - Simplifying power'){
          skipTooltipButton.innerHTML = 'See more for the "Submit a transfer';
          this.oncomplete( function(){ 
            window.location.href = 'submit.php?multipage=true';
          });
        }else if (document.title == 'WebFTS - Simplifying power - Submit'){
          skipTooltipButton.innerHTML = 'Explore the "My Jobs" page';
          this.oncomplete( function(){ 
